<html>
    ...
    <body class="container" style="background:radial-gradient(#f5cdcd,#ad7a71);">
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        ...
        <form name="myForm" onsubmit="return validateForm()" action="./entryBiodata.Controller.php" method="POST" style="background-color:rgb(190, 215, 229); ">
          <div class="col-sm-12"> 
          <h1 class="border-bottom center pb-3 mb-4" style="text-align: center;">Rent Now</h1>
        </div> 
                ...
                <div class="form-group row">
                  <div class="col-sm-1"></div>
                    <label class="col-sm-3">Returning Date:</label>
                    <div class="col-sm-3">
              ...
              <!--  <div class="form-group row">
                  <div class="col-sm-1"></div>
                  <label class="col-sm-3 " >ReturnDate:</label>
                  <div class="col-sm-6">
				...
				<img src="cebc8cd5-6d51-45c6-98eb-b82a4d8d19cf.jpg"/>
